Vue.component('Windows', {
    template: '<div><div class="dashBorder"></div><span class="infoTitle">{{i18ns.OSDeploy.deploy_installInfo}}</span><el-row><el-form label-position="left" :model="deployForm" :rules="rules" ref="deployForm" label-width="250px" ><el-col :span="13"><el-form-item :label="i18ns.OSDeploy.deploy_installCDKey" >' +
        ...
        '</el-row></el-popover></el-form-item></el-col>'+
        '<el-col :span="13">'+
        '<el-form-item :label="i18ns.OSDeploy.OSDeploy_installOption" prop="Option">'+
        '<el-select v-model="deployForm.Option" >'+
        '<el-option v-for="item in Options" :key="item.Option" :label="item.Option" :value="item.Option"></el-option>'+
        '</el-select>'+
        '</el-form-item>'+
        '</el-col>'+
        '<el-col :span="13"><el-form-item :label="i18ns.OSDeploy.deploy_cpFirstNameWin" >' +
        '<el-row>' +
        '<el-col :span="12">' +
