var errorCode_zh_CN = {
    ...
    "FusionDirector.1.0.SwitchProfileError12": {
        "Message": "端口已经关联使能隧道功能的网络，不允许再关联其他网络",
        "NumberOfArgs": 0,
...
var errorCode_en = {
    ...
    "FusionDirector.1.0.SwitchProfileError12": {
        "Message": "The port is associated with the network where the tunnel function is enabled and cannot be associated with other networks.",
        "NumberOfArgs": 0,
