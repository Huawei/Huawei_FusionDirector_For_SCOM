Vue.component('item-bios', {
    ...
    methods: {
        initBIOS: function () {
            ...
            Vue.nextTick(function () {
                for (var i = 0; i < that.bios_info.ConfigList.Attributes.length; i++) {
                    ...
                    //console.log(item.AttributeName, that.biosItemValues[item.AttributeName]);
        ...
        getBiosItemDisplayName: function (attributeName) {
            return _.find(this.bios_info.ConfigList.Attributes, function (item) {
        ...
        setValue: function (attributeName) {
            var dependencies = _.filter(this.bios_info.ConfigList.Dependencies, function (x) {
                return x.DependencyFor == attributeName &&
