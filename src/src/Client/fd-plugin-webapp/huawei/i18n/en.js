var i18n_en = {
    ...
    FDConfig: {
        ...
        nameNull: 'UserName cannot be empty',
        ...
        hostIPError: 'Invalid IP address',
        ...
        register: 'Register',
        alarmUsername: 'AlarmServiceUser',
        alarmPassword: 'AlarmServicePassword',
        alarmUsernameNullTips: 'AlarmServiceUser cannot be empty',
        alarmPasswordNullTips: 'AlarmServicePassword cannot be empty',
    ...
    imageManage: {
        ...
        uploadTips: 'Uploaded to vCenter server, synchronizing image',
        imageManage_fileTips: "Uploading ... Do not perform other operations on the page; otherwise, the uploading will be canceled.",
    ...
    OSDeploy: {
        ...
        OSDeploy_errorPasswordLinux: "The password must contain more than six characters,but cannot contain #,or $.",
    ...
    setting: {
        ...
        vCenterTips: "Description:vCenter account is used to push basic server information to Huawei host information",
    },
    upgradePackageWarehouse: {
        ...
        versionWarehouse_leastVersion: "Huawei's latest baseline",

        versionWarehouse_uploadPackages: "Upload Update Package",
        versionWarehouse_packageName: "Package Name",
        ...
        versionWarehouse_createTime: "Created At",
        ...
        versionWarehouse_upgrading: "Updating",
        versionWarehouse_singlePackage: "Single Package",
        ...
        versionWarehouse_baselineDescription: "Baseline Description",
        versionWarehouse_baseline: "Baseline",
        versionWarehouse_upgradePackage: "Update Package",
        versionWarehouse_baselineCompare: "Baseline Comparison",
        versionWarehouse_versionMessage: "Version Information",
        versionWarehouse_selectVersion: "Select Version",
        versionWarehouse_baselineVersionMessage: "Baseline Information",
        versionWarehouse_addUpgradePackage: "Add Update Package",
        versionWarehouse_deleteAll: "Delete All",
        versionWarehouse_productTypeOne: "Product Type",
        versionWarehouse_firmwareType: "Firmware Type",
        versionWarehouse_all: "All",
        ...
        versionWarehouse_baselinePackageSelectedTip: "You can select only one baseline. Replace the update package in the baseline information list as required and click OK to replace the original baseline.",
        versionWarehouse_baselinePackageRepeat: "Are you sure you want to replace the selected update package?",
        versionWarehouse_baselinePackageRepeatTip: "The following version conflicts with the selected version. Click Yes to confirm the replacement.",
        ...
        versionWarehouse_upgradePackageRepeatTip: "Some selected update packages are the same as those in the following update package or baseline. Click Yes to add only the update packages that are not repeated.",
        ...
        versionWarehouse_huaweiOfficiallyReleases: "Huawei officially releases the latest baseline. The latest baseline is {1}.",
        versionWarehouse_alreadyBaseline: "Selected Baseline",
        versionWarehouse_onlineAddress: "Website",
        versionWarehouse_networkUnknownFailed: "The access fails due to unknown reasons.",
        versionWarehouse_networkUnknownFailedMethod: "1 Check whether network connection is normal. 2. Check whether the website is correct. 3. Check whether the DNS or proxy is available. If the problem persists, contact Huawei technical support.",
        ...
        versionWarehouse_networkOK: "Authorized access",
        ...
        versionWarehouse_upgradePackageList: "Upgrade package list",
        configInfo_inputNotNull: "This field cannot be left blank."
    },
    deviceVersionStatus: {
        deviceVersionStatus_Chassis: "Chassis",
        deviceVersionStatus_BMCIP: "BMP IP",
        deviceVersionStatus_serialNumber: "SN",
        deviceVersionStatus_status: "Status",
        deviceVersionStatus_productType: "Product Model",
        deviceVersionStatus_baselineUpgradePackage: "Baseline/Update Package",
        deviceVersionStatus_plan: "Schedule",
        deviceVersionStatus_upgradeTime: "Update Time",

        deviceVersionStatus_ChassisName: "Chassis Name",

        deviceVersionStatus_EMIP: "EM IP",
        ...
        deviceVersionStatus_deleteMoreErrorTip: "Select one or more records to take effect.",
        deviceVersionStatus_activeFireWareTuskTip: "The task has been started. You can view the task list to see the progress.",

        deviceVersionStatus_firmwareType: "Firmware Type",
        deviceVersionStatus_name: "Name",
        ...
        deviceVersionStatus_SearchTip: "Enter a baseline, update package, or schedule"
    },
    upgradePlan: {
        ...
        upgradePlan_filterDevice: "Failed to update the devices because the devices in the group are not filtered.",
