...
namespace CommonUtil
{
    ...
    public class EncryptUtil
    {
        ...
        /// 密钥存储路径，放在user目录下。
        /// </summary>
        static string rootFolderPath = rootPath + "\\Huawei\\SCCM Plugin For Fusion Director";
        //密钥组件分散保存，当密钥组件存储于文件中时，不能所有的组件文件放在同一目录下存储；
        //因此加多一层目录.
        static string rootFile = rootPath + "\\Huawei\\SCCM Plugin For Fusion Director\\base.kn";
        static string mainFile = rootPath + "\\Huawei\\SCCM Plugin For Fusion Director\\main\\main.kn";
        /// <summary>
        /// 获得根密钥
        /// </summary>
        /// <returns>根密钥</returns>
        ...
        #region 兼容旧的密钥
        static string versionFile = rootPath + "\\Huawei\\SCCM Plugin For Fusion Director\\vrn.kn";
