...
!define PRODUCT_NAME "Huawei Fusion Director For SCOM plugin"
...
LangString Lan_ConfigTip_Msg ${LANG_SIMPCHINESE} "请输入可以被Fusion Director访问的本地IP地址和端口号(44300-44399)。"
...
LangString Lan_agreeLabel_Msg ${LANG_ENGLISH} "Used to receive alerts from Fusion Director and provide WEB service, It will be install IIS Express on this server."
LangString Lan_agreeLabel_Msg ${LANG_SIMPCHINESE} "用于从Fusion Director接收警报并提供WEB服务，它将在此服务器上安装IIS Express。"
...
OutFile "Huawei_FusionDirector_For_SCOM_Plugin_${VERSION}.${BUILD_NUMBER}.exe"
InstallDir "$PROGRAMFILES64\Huawei Fusion Director For SCOM plugin"
...
Function .onGUIEnd
     nsExec::ExecToLog 'net start "Huawei Fusion Director For SCOM plugin Service"'
FunctionEnd
